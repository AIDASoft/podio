...
public:
  ...
  virtual unsigned getEntries() const override { return runTimed(false, "get_entries", &IReader::getEntries); }
  ...
  virtual void closeFile() override { runVoidTimed(false, "close_file", &IReader::closeFile); }
