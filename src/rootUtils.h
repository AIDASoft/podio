...
#include "podio/ROOTReader.h" // For NamedCollInfo
...
inline std::tuple<std::vector<root_utils::CollectionBranches>, std::vector<detail::NamedCollInfo>>
...
inline std::vector<std::string> getAvailableCategories(TChain* metaChain) {
