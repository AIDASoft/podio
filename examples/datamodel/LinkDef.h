...
#pragma link C++ class ParticleAssociation+;
#pragma link C++ class std::vector<ParticleAssociation>+;
#pragma link C++ class ParticleAssociationHandle+;
#pragma link C++ class ParticleAssociationCollection+;
