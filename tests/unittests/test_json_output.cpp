...
TEST_CASE("JSON output - plain objects", "[json]") {
  SECTION("plain POD members") {
  ...
  SECTION("default object keeps keys") {
    auto hit = MutableExampleHit{};
...
TEST_CASE("JSON output - VectorMembers", "[json]") {
  using Catch::Matchers::Equals;

  SECTION("serialize as arrays") {
  ...
  SECTION("empty VectorMember becomes empty array") {
    auto obj = MutableExampleWithVectorMember{};
...
TEST_CASE("JSON output - OneToOneRelation", "[json]") {
  SECTION("serializes") {
...
TEST_CASE("JSON output - OneToManyRelation", "[json]") {
  SECTION("serializes as array") {
  ...
  SECTION("empty relation is empty array") {
    auto cluster = MutableExampleCluster{};
...
TEST_CASE("JSON output - collection", "[json]") {
  SECTION("serializes to array") {
  ...
  SECTION("empty collection is empty array") {
    ExampleHitCollection hits{};
