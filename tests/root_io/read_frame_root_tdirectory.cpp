//
// This duplicated from read_frame_root_multiple.cpp and modified to check
// ROOTReader::openTDirectory
//
...
int main() {
  std::cout << "- - - openTDirectory" << std::endl;
  auto reader = podio::ROOTReader();
  TFile f("example_frame.root");
  reader.openTDirectory(&f);
