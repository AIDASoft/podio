...
ExampleWithStringCollection::ExampleWithStringCollection() : m_isValid(false), m_collectionID(0), m_entries() ,m_refCollections(nullptr), m_data(new ExampleWithStringDataContainer() ) {
