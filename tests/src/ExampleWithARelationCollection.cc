...
ExampleWithARelationCollection::ExampleWithARelationCollection() : m_isValid(false), m_collectionID(0), m_entries() , m_rel_ref(new std::vector<ex::ExampleWithNamespace>()),m_data(new ExampleWithARelationDataContainer() ) {
