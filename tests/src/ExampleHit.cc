...
void ExampleHit::x(double value){ m_obj->checkAccess(); m_obj->data.x = value; }
void ExampleHit::y(double value){ m_obj->checkAccess(); m_obj->data.y = value; }
void ExampleHit::z(double value){ m_obj->checkAccess(); m_obj->data.z = value; }
void ExampleHit::energy(double value){ m_obj->checkAccess(); m_obj->data.energy = value; }
