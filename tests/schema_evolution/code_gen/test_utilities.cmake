...
function(GENERATE_DATAMODEL test_case model_version)
  cmake_parse_arguments(PARSED_ARGS "WITH_EVOLUTION" "" "OLD_VERSIONS" ${ARGN})
...
function(ADD_SCHEMA_EVOLUTION_TEST test_case)
  cmake_parse_arguments(PARSED_ARGS "RNTUPLE;NO_GENERATE_MODELS;WITH_EVOLUTION" "" "OLD_MODELS" ${ARGN})
  ...
  foreach(old_version ${old_versions})
    ...
    set_property(TEST schema_evol:code_gen:${test_case}:write_${old_version}${suffix}
      PROPERTY ENVIRONMENT
        LD_LIBRARY_PATH=${PROJECT_BINARY_DIR}/src:${CMAKE_CURRENT_BINARY_DIR}/${test_case}/${old_version}_model:$<TARGET_FILE_DIR:ROOT::Tree>:$<$<TARGET_EXISTS:SIO::sio>:$<TARGET_FILE_DIR:SIO::sio>>:$ENV{LD_LIBRARY_PATH}
        PODIO_SIO_BLOCK=${CMAKE_CURRENT_BINARY_DIR}/${test_case}/${old_version}_model
    )
