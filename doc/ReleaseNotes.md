...
* 2026-08-27 Juan Miguel Carceller ([PR#1012](https://github.com/AIDASoft/podio/pull/1012))
  - Detach the metadata `TTree` from the output `TFile` before closing the file.

* 2026-08-27 Thomas Madlener ([PR#1011](https://github.com/AIDASoft/podio/pull/1011))
  - Add a `LinkCollection::create` overload that takes the objects that should be linked to facilitate creating links.

* 2026-08-26 Mateusz Jakub Fila ([PR#1010](https://github.com/AIDASoft/podio/pull/1010))
  - Pin pre-commit hook revisions with SHA rather than tag name

* 2026-08-26 arnavdham ([PR#1002](https://github.com/AIDASoft/podio/pull/1002))
...
* 2026-08-26 Juan Miguel Carceller ([PR#998](https://github.com/AIDASoft/podio/pull/998))
  - Add GCC 16 coverage in the CI test matrix.

* 2026-08-24 Juan Miguel Carceller ([PR#1007](https://github.com/AIDASoft/podio/pull/1007))
...
* 2026-08-19 Wouter Deconinck ([PR#1003](https://github.com/AIDASoft/podio/pull/1003))
  - fix: avoid dangling string_view keys in RNTupleReader maps

* 2026-08-16 Wouter Deconinck ([PR#1005](https://github.com/AIDASoft/podio/pull/1005))
  - fix(cmake): typo USE_SANITIZE => USE_SANITIZER

* 2026-08-13 arnavdham ([PR#999](https://github.com/AIDASoft/podio/pull/999))
...
* 2026-08-12 arnavdham ([PR#1001](https://github.com/AIDASoft/podio/pull/1001))
  - Optimized the Arrow backend read path by eliminating vector reallocation overhead and redundant O(N) schema lookups.

* 2026-08-04 arnavdham ([PR#987](https://github.com/AIDASoft/podio/pull/987))
...
* 2026-07-30 Juan Miguel Carceller ([PR#995](https://github.com/AIDASoft/podio/pull/995))
  - Look for `lz4` quietly when looking for Arrow to avoid a warning when `lz4` doesn't provide a CMake config file.

* 2026-07-29 Juan Miguel Carceller ([PR#994](https://github.com/AIDASoft/podio/pull/994))
...
* 2026-07-27 Thomas Madlener ([PR#954](https://github.com/AIDASoft/podio/pull/954))
  - Extract common functionality related to file versions and datamodels into a `ReaderCommon` utility class.

* 2026-07-26 arnavdham ([PR#990](https://github.com/AIDASoft/podio/pull/990))
  - Cleans up the package configuration by exporting only the prefixed variables (`PODIO_ENABLE_SIO` and `PODIO_ENABLE_ARROW`) and check both the prefix and the unprefixed ones.

* 2026-07-24 Juan Miguel Carceller ([PR#993](https://github.com/AIDASoft/podio/pull/993))
  - Let ROOT bind to the right type instead of casting to std::vector<int>

* 2026-07-24 Juan Miguel Carceller ([PR#992](https://github.com/AIDASoft/podio/pull/992))
...
* 2026-07-20 Juan Miguel Carceller ([PR#989](https://github.com/AIDASoft/podio/pull/989))
...
* 2026-07-16 Juan Miguel Carceller ([PR#988](https://github.com/AIDASoft/podio/pull/988))
  - Group together tests that are small and related, to launch one process per group and have less clutter when running CTest

* 2026-07-15 arnavdham ([PR#980](https://github.com/AIDASoft/podio/pull/980))
  - Implement a `frameToTable` conversion layer to map PODIO `Frame`s and collection data types to Apache Arrow `Table`s, where each `Frame` maps to a single row.
  - Add thread-safe global registries (`ArrowTypeRegistry` and `ArrowConverterRegistry`) for mapping PODIO collections to Arrow data types and serialization functions.
  - Introduce `ArrowFrameConverter::convertFrameToTable` to translate regular collections, subset collections, and frame parameters.
  - Update code generation with `ArrowMapper` templates and Jinja2 macros to dynamically generate schema definitions and register serializers for custom EDMs, including support for complex types, fixed-size arrays, and relationships.

* 2026-07-02 Juan Miguel Carceller ([PR#985](https://github.com/AIDASoft/podio/pull/985))
  - Sort categories in getAvailableCategories for RNTuples
  - Sort categories (alphabetically, ignoring case) in `podio-dump`

* 2026-07-02 Juan Miguel Carceller ([PR#952](https://github.com/AIDASoft/podio/pull/952))
...
* 2026-07-01 Juan Miguel Carceller ([PR#984](https://github.com/AIDASoft/podio/pull/984))
  - Add a test for the unused method `getN` in GenericParameters

* 2026-06-28 Juan Miguel Carceller ([PR#983](https://github.com/AIDASoft/podio/pull/983))
...
* 2026-06-28 Thomas Madlener ([PR#979](https://github.com/AIDASoft/podio/pull/979))
  - Add support for renaming datatypes in schema evolution. The renaming is auto detected (there is no need for an evolution file) by checking if the new datatype has the same members and types as an old dropped datatype.
  - Add a test with a type that is renamed

* 2026-06-27 Juan Miguel Carceller ([PR#982](https://github.com/AIDASoft/podio/pull/982))
  - Allow subprocess aborted in the read_garbage test

* 2026-06-21 Juan Miguel Carceller ([PR#978](https://github.com/AIDASoft/podio/pull/978))
  - Update the sanitizer workflow to use the latest available compilers, GCC 16 and Clang 22

* 2026-06-20 Juan Miguel Carceller ([PR#974](https://github.com/AIDASoft/podio/pull/974))
  - Exclude the datamodel.h header from being added to ROOT dictionaries

* 2026-06-19 Juan Miguel Carceller ([PR#977](https://github.com/AIDASoft/podio/pull/977))
  - Fix compilation with fmt 12.2.0 by including a missing fmt/ranges.h

* 2026-06-19 Juan Miguel Carceller ([PR#971](https://github.com/AIDASoft/podio/pull/971))
  - Remove the deprecated getValue() in Interfaces

* 2026-06-18 Juan Miguel Carceller ([PR#975](https://github.com/AIDASoft/podio/pull/975))
  - Change CI to use Clang22 instead of Clang19, soon unsupported

* 2026-06-18 Juan Miguel Carceller ([PR#972](https://github.com/AIDASoft/podio/pull/972))
  - Remove the deprecated getter without "get" before the name

* 2026-06-09 arnavdham ([PR#966](https://github.com/AIDASoft/podio/pull/966))
  - Lay the initial foundation for the Apache Arrow backend by implementing compile-time schema mapper generation within the python code generator engine.
  - Add support for translating YAML-defined Event Data Models (EDMs) into Apache Arrow schema structures, including support for primitives, components, relations, and frame parameters.

* 2026-06-02 Thomas Madlener ([PR#955](https://github.com/AIDASoft/podio/pull/955))
  - Add tests that run I/O on multiple threads

* 2026-04-17 Thomas Madlener ([PR#963](https://github.com/AIDASoft/podio/pull/963))
  - Pin all used github actions to the commit that corresponds to the latest released tag

* 2026-04-17 Juan Miguel Carceller ([PR#957](https://github.com/AIDASoft/podio/pull/957))
  - Add dependabot

* 2026-04-17 Juan Miguel Carceller ([PR#956](https://github.com/AIDASoft/podio/pull/956))
  - Add help to json-to-yaml, reduce unexpectedness

* 2026-03-24 Thomas Madlener ([PR#946](https://github.com/AIDASoft/podio/pull/946))
  - Make many of the reader and writer interfaces accept `std::string_view` arguments instead of `const std::string&` for categories, etc. to be more overall more consistent and to avoid having to do `string_view` to `string` conversions on the user side (see also [#945](https://github.com/AIDASoft/podio/issue/945)).

* 2026-03-17 Juan Miguel Carceller ([PR#947](https://github.com/AIDASoft/podio/pull/947))
  - Use `__LINE__` instead of `__COUNTER__` since it is standard C++. This would only be problematic if the macro where they are used would happen multiple times in the same line, but since this is only being used in a .cc file and not in headers it should be safe.
...
* 2026-03-17 Juan Miguel Carceller ([PR#944](https://github.com/AIDASoft/podio/pull/944))
  - Make `CollectionReadBuffers` movable only. This means the `CollectionReadBuffers` own their data unless they give ownership away.
  - Cleanup the rest of the code, use `std::move` instead of copying (not allowed now), simplify a few cleanup steps and make sure everything is deleted and set to `nullptr` in a few places like in `LinkCollectionImpl`

* 2026-03-16 Juan Miguel Carceller ([PR#948](https://github.com/AIDASoft/podio/pull/948))
  - Fix several issues that were uncovered when running CI. The issues were there before, we just don't have changes that make loading a symbol in other libraries not work anymore.
    - Because FCCAnalyses provides `ROOT::VecOps::RVec<std::vector<int>>` (and the same for `float` and `double`) https://github.com/HEP-FCC/FCCAnalyses/blob/dabdfaf92f716373dc000509766bdd827dc07392/analyzers/dataframe/FCCAnalyses/LinkDef.h#L35, ROOT will load FCCAnalyses (`libFCCAnalyses`) that will load EDM4hep in the stack which has a symbol that does not exist anymore because it is being changed in this PR. The changes in `rds_selection.xml` provide `ROOT::VecOps::RVec<std::vector<int>>` 
    - There are multiple changes not to use the namespace `edm4hep` (and use `edm4hepLike` instead) in tests since this will also trigger loading `libedm4hep` and not finding a symbol.
    - Passing `DL_PATHS` to Catch2 seems to be needed on Ubuntu to make sure the built `libpodio` is found instead of the one from the stack.

* 2026-03-09 Juan Miguel Carceller ([PR#943](https://github.com/AIDASoft/podio/pull/943))
...
* 2026-03-09 Juan Miguel Carceller ([PR#942](https://github.com/AIDASoft/podio/pull/942))
  - Rename `CMAKE_{SOURCE,BIN}_DIR` to `PROJECT_{SOURCE,BIN}_DIR`

* 2026-03-05 Juan Miguel Carceller ([PR#940](https://github.com/AIDASoft/podio/pull/940))
...
* 2026-02-25 Andre Sailer ([PR#937](https://github.com/AIDASoft/podio/pull/937))
  - Contributing: add note about usage of LLMs and PR review time expectation.
  - Contributing: update git workflow, drop dead link, specifically mention rebase

* 2026-02-25 Thomas Madlener ([PR#936](https://github.com/AIDASoft/podio/pull/936))
  - Introduce explicitly named `getLinkedFrom` and `getLinkedTo` methods to the `LinkNavigator` for handling links with the same `FromT` and `ToT`. Deprecated the tag-dipatched `getLinked` versions and also the `podio::Return[From|To]` tags. **Behavior or links with different `FromT` and `ToT` is not affected!**.

* 2026-02-23 Thomas Madlener ([PR#919](https://github.com/AIDASoft/podio/pull/919))
...
* 2026-02-16 Juan Miguel Carceller ([PR#934](https://github.com/AIDASoft/podio/pull/934))
  - Use Clang 19 instead of 16 in CI, since these builds are going to be revomed

* 2026-02-04 Thomas Madlener ([PR#923](https://github.com/AIDASoft/podio/pull/923))
  - Add a `from` factory function to create collections from ranges of (mutable or immutable) handles

* 2026-02-03 Thomas Madlener ([PR#905](https://github.com/AIDASoft/podio/pull/905))
  - Add a few [cmake presets](https://cmake.org/cmake/help/latest/manual/cmake-presets.7.html) to put common build options together. Use `cmake --list-presets` to see the available presets.
  - Use presets in CI workflows to reduce some of the duplication that is currently present

* 2026-01-19 Mateusz Jakub Fila ([PR#927](https://github.com/AIDASoft/podio/pull/927))
  - find `Python3` in `find_dependency`

* 2026-01-19 Mateusz Jakub Fila ([PR#926](https://github.com/AIDASoft/podio/pull/926))
  - Include `Python.h` before standard headers

* 2026-01-16 Juan Miguel Carceller ([PR#924](https://github.com/AIDASoft/podio/pull/924))
  - Remove extra `>` in RNTupleWriter.cc

* 2026-01-15 Thomas Madlener ([PR#922](https://github.com/AIDASoft/podio/pull/922))
