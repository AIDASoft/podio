...
class DataType(object):
  ...
  def __init__(self, klass, schema_version="v1"):
  ...
  def __str__(self):
    if self.namespace:
      scoped_type = '::{}::{}::{}'.format(self.namespace, self.schema_version, self.bare_type)
    else:
      scoped_type = '{}::{}'.format(self.schema_version, self.full_type)
