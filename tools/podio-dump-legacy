...
if __name__ == "__main__":
    ...
    _epilog = (
        "NOTE: This is a legacy implementation in python. A newer version based on a c++ implementation is available. "
        "That version is much faster, but does not handle pre-release version files."
    )
